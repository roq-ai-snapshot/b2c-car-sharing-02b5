...
export function useDashboardFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDashboardFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.dashboard.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDashboardCount<T extends Prisma.dashboardCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.dashboardCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useDashboardCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.dashboard.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDashboardFindManyWithCount<
  T extends Prisma.dashboardFindManyArgs,
  R extends { data: GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.dashboardFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDashboardFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.dashboard.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDashboardFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDashboardFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.dashboard.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operation.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationCount<T extends Prisma.operationCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.operationCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operation.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationFindManyWithCount<
  T extends Prisma.operationFindManyArgs,
  R extends { data: GetFindResult<Prisma.$operationPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.operationFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operation.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useOperationFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useOperationFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.operation.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
