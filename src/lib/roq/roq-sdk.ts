...
import type { Prisma, booking, car, company, dashboard, operation, user } from './types';
...
interface DashboardSDK {
  create: <T extends Prisma.dashboardCreateArgs, R extends CheckSelect<T, dashboard, Prisma.dashboardGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.dashboardCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.dashboardCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.dashboardCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.dashboardUpdateArgs, R extends Prisma.dashboardGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.dashboardUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.dashboardUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.dashboardUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.dashboardUpsertArgs, R extends Prisma.dashboardGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.dashboardUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.dashboardDeleteArgs, R extends Prisma.dashboardGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.dashboardDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.dashboardDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.dashboardDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <
    T extends Prisma.dashboardFindManyArgs,
    R extends GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>[],
  >(
    args: Prisma.SelectSubset<T, Prisma.dashboardFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.dashboardCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.dashboardCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  findFirst: <
    T extends Prisma.dashboardFindFirstArgs,
    R extends GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>,
  >(
    args?: Prisma.SelectSubset<T, Prisma.dashboardFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient {
  ...
  private initSDK() {
    ...
    this.dashboard = {
      create: async function createDashboard<
        T extends Prisma.dashboardCreateArgs,
        R extends CheckSelect<T, dashboard, Prisma.dashboardGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/dashboard/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyDashboard<
        T extends Prisma.dashboardCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/dashboard/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateDashboard<
        T extends Prisma.dashboardUpdateArgs,
        R extends Prisma.dashboardGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/dashboard/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyDashboard<
        T extends Prisma.dashboardUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/dashboard/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertDashboard<
        T extends Prisma.dashboardUpsertArgs,
        R extends Prisma.dashboardGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/dashboard/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteDashboard<
        T extends Prisma.dashboardDeleteArgs,
        R extends Prisma.dashboardGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/dashboard/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyDashboard<
        T extends Prisma.dashboardDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.dashboardDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/dashboard/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyDashboard<
        T extends Prisma.dashboardFindManyArgs,
        R extends GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.dashboardFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/dashboard/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countDashboard<T extends Prisma.dashboardCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.dashboardCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/dashboard/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountDashboard<
        T extends Prisma.dashboardFindManyArgs,
        R extends GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.dashboardFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.dashboard.findMany(args, options),
          ctx.dashboard.count(
            {
              distinct,
              orderBy,
      ...
      findFirst: async function findFirstDashboard<
        T extends Prisma.dashboardFindFirstArgs,
        R extends GetFindResult<Prisma.$dashboardPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.dashboardFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/dashboard/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
