  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing: Your Personalized Vehicle Booking Platform. Conveniently find cars near you, managed by dedicated operations staff from central dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing: Your Personalized Vehicle Booking Platform. Conveniently find cars near you, managed by dedicated operations staff from central dashboards.`}
            </Text>
            <Box
